...
.method private adjustDisplayTimeRange()Ljava/util/List;
    ...
    const-string v3, "updated display range : "
...
.method private applyRandomTimeForDisplay(Ljava/util/Calendar;IIJI)V
    ...
    iget-object p6, p0, Lcom/samsung/android/sdk/smp/marketing/Marketing;->mMid:Ljava/lang/String;

    new-instance v2, Ljava/lang/StringBuilder;

    const-string v3, "random display(s):"
    ...
    invoke-static {p1, p6, p2}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private checkFilterInstall(Landroid/content/Context;)Z
    ...
    invoke-static {p1, v1, v0}, Landroid/support/v4/media/e;->w(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private onGetMarketingStatusFail(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p2, v0, v3}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setToFail(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v4, p2, v6}, Lcom/samsung/android/sdk/smp/task/SMarketingTask;-><init>(Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;Landroid/os/Bundle;Ljava/lang/String;)V
...
.method private onResourceDownloadFail(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p2, v0, v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setToFail(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, v2, p2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setToFail(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public requestGetMarketingStatus(Landroid/content/Context;)V
    ...
    :cond_0
    new-instance v1, Lcom/samsung/android/sdk/smp/marketing/GetMarketingStatusRequest;

    iget-object v2, p0, Lcom/samsung/android/sdk/smp/marketing/Marketing;->mMid:Ljava/lang/String;

    const/4 v3, 0x0

    invoke-direct {v1, v2, v0, v3}, Lcom/samsung/android/sdk/smp/marketing/GetMarketingStatusRequest;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const/16 v0, 0x3c

    invoke-static {p1, v1, v0}, Lcom/samsung/android/sdk/smp/common/network/NetworkManager;->request(Landroid/content/Context;Lcom/samsung/android/sdk/smp/common/network/NetworkRequest;I)Lcom/samsung/android/sdk/smp/common/network/NetworkResult;
...
.method public updateExpectedDisplayTime(Landroid/content/Context;)V
    ...
    const-string v4, "update expected display time:"
