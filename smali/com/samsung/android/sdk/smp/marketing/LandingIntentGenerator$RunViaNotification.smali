...
.field private static final PARAM_REDIRECT_FEEDBACK_ID:Ljava/lang/String; = "fbid"
...
.method private appendSmpPKToRedirectionUri(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Z)Landroid/net/Uri;
    ...
    invoke-static {v2, p1, p2, v1, p4}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;->access$400(Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Z)Landroid/net/Uri;
...
.method private getRedirectionUri(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Z)Landroid/net/Uri;
    .locals 2
    ...
    invoke-direct {p0, p1, p6}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->appendWebIdToRedirectionUri(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-direct {p0, p4, p6}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->appendWebIdToRedirectionUri(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p4

    invoke-direct {p0, p5, p4, p2}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->appendReferrerToRedirectionUri(Ljava/lang/String;Landroid/net/Uri;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;)Landroid/net/Uri;

    move-result-object p2

    invoke-direct {p0, p1, p5, p2, p7}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->appendSmpPKToRedirectionUri(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Z)Landroid/net/Uri;
    ...
    invoke-static {p2, p3, p1}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;->access$300(Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;Landroid/net/Uri;)Landroid/net/Uri;
...
# virtual methods
.method public getLandingIntentForRedirectionUrl(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;Landroid/content/Intent;Z)Landroid/content/Intent;
    .locals 11
    ...
    invoke-virtual {p4}, Lcom/samsung/android/sdk/smp/marketing/MarketingLink;->getRedirectionUrl()Ljava/lang/String;
    ...
    const-string v2, "fail to get redirection intent. webid is null"

    invoke-static {v0, p2, v2}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    return-object v1

    :cond_1
    iget-object v0, v8, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->this$0:Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;
    ...
    invoke-direct {p0, p1, v4}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->isIntentLaunchableWithBrowsable(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    const-string v2, "fail to get redirection intent. not launchable when adding browsable category"
    ...
    invoke-direct/range {v0 .. v7}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->getRedirectionUri(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunViaNotification;->setFlags(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, p2, v2}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingLandingRedirected(Ljava/lang/String;Ljava/lang/Boolean;)Z
