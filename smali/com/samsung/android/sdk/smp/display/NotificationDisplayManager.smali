...
.method private getButtonNum(I)Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;
    .locals 1
    ...
    sget-object p1, Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;->NONE:Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;

    return-object p1

    :cond_0
    sget-object p1, Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;->THIRD:Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;

    return-object p1

    :cond_1
    sget-object p1, Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;->SECOND:Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;

    return-object p1

    :cond_2
    sget-object p1, Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;->FIRST:Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;
...
.method private getClickPendingIntent(Landroid/content/Context;Ljava/lang/String;IZLjava/util/ArrayList;)Landroid/app/PendingIntent;
    ...
    :cond_0
    sget-object v5, Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;->NONE:Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;
    ...
    invoke-virtual/range {v2 .. v9}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->getClickPendingIntentSOrOver(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;ILjava/util/ArrayList;ZZ)Landroid/app/PendingIntent;
...
.method private getNotificationButtonClickIntentUnderS(Ljava/lang/String;ILjava/util/ArrayList;ILandroid/content/Context;Z)Landroid/content/Intent;
    ...
    invoke-static {p1, p2}, Landroid/support/v4/media/e;->o(ILjava/lang/String;)Ljava/lang/String;
...
.method private getNotificationButtonClickPendingIntent(Ljava/lang/String;ILjava/util/ArrayList;ILandroid/content/Context;Z)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, p2}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->getButtonNum(I)Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;
    ...
    invoke-static {p5, p4, v1, v2}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private setNotificationConfigs(Landroid/content/Context;Landroid/os/Bundle;Landroid/app/Notification;)V
    ...
    invoke-virtual {p2}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->getNotiColor()I

    move-result p2

    if-eqz p2, :cond_1

    iput p2, p3, Landroid/app/Notification;->color:I
...
.method public getClickPendingIntentSOrOver(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;ILjava/util/ArrayList;ZZ)Landroid/app/PendingIntent;
    .locals 17
    ...
    invoke-static {v0, v9, v1}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v13, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;
    ...
    invoke-direct {v13, v0}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;-><init>(Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunType;)V
    ...
    invoke-direct {v6, v8, v9, v10}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->getDeletePendingIntent(Landroid/content/Context;Ljava/lang/String;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;->getLandingIntentByLinkType(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/NotificationButtonNumber;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;ZZZ)Landroid/content/Intent;
    ...
    invoke-static {v1, v9, v2}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v9, v1}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
