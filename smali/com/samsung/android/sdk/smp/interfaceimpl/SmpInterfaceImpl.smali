...
.method private static clearSmpData(Landroid/content/Context;I)Lcom/samsung/android/sdk/smp/SmpResult;
    ...
    invoke-direct {p1, v5, p0}, Lcom/samsung/android/sdk/smp/SmpResult;-><init>(ZLandroid/os/Bundle;)V
    ...
    const-string v2, "SmpId is not generated yet. clear device data only"
    ...
    invoke-static/range {v2 .. v8}, Lcom/samsung/android/sdk/smp/data/DataManager;->clearSmpData(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZLjava/lang/String;)Lcom/samsung/android/sdk/smp/SmpResult;
...
.method private static getDelimiter(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {p1, p0}, Landroid/support/v4/media/e;->q(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static getOptIn(Landroid/content/Context;)Lcom/samsung/android/sdk/smp/SmpResult;
    ...
    const-string v0, "device does not support getOptIn"
    ...
    const-string v1, "SMP_0204"

    invoke-virtual {p0, v0, v1}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "error_message"

    const-string v1, "The device does not support opt-in/out"
    ...
    invoke-direct {v0, v1, p0}, Lcom/samsung/android/sdk/smp/SmpResult;-><init>(ZLandroid/os/Bundle;)V
...
.method private static getSuccessSmpResult(ZJ)Lcom/samsung/android/sdk/smp/SmpResult;
    .locals 2
    ...
    invoke-direct {p0, p1, v0}, Lcom/samsung/android/sdk/smp/SmpResult;-><init>(ZLandroid/os/Bundle;)V
...
.method public static setNotifChannel(Landroid/content/Context;Ljava/util/Map;)V
    ...
    invoke-static {p1, v3, v0}, Landroid/support/v4/media/e;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static declared-synchronized setOptIn(Landroid/content/Context;ZJ)Lcom/samsung/android/sdk/smp/SmpResult;
    .locals 6

    const-string v0, "optOut success. - optInTime: "

    const-string v1, "optIn success. - optInTime: "

    const-string v2, "setOptIn - optIn: "

    const-class v3, Lcom/samsung/android/sdk/smp/interfaceimpl/SmpInterfaceImpl;
    ...
    :cond_0
    :try_start_1
    sget-object v4, Lcom/samsung/android/sdk/smp/interfaceimpl/SmpInterfaceImpl;->TAG:Ljava/lang/String;
    ...
    invoke-static {v4, v2}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p1}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setOptIn(Z)V

    invoke-virtual {v2, p2, p3}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setOptInTime(J)V

    invoke-static {p1, p2, p3}, Lcom/samsung/android/sdk/smp/interfaceimpl/SmpInterfaceImpl;->getSuccessSmpResult(ZJ)Lcom/samsung/android/sdk/smp/SmpResult;
    ...
    invoke-static {v4, p2}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->hi(Ljava/lang/String;Ljava/lang/String;)V
