...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object p1, p0, Ln/c;->c:Landroid/view/View;
...
.method public final a(FFZ)Z
    ...
    iget-boolean v0, p0, Ln/c;->d:Z

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {p0, v1}, Ln/c;->e(I)Landroid/view/ViewParent;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v2, p0, Ln/c;->c:Landroid/view/View;
...
.method public final c(II[I[II)Z
    ...
    invoke-virtual {p0, p5}, Ln/c;->e(I)Landroid/view/ViewParent;
    ...
    :cond_2
    :goto_0
    iget-object v3, p0, Ln/c;->c:Landroid/view/View;
    ...
    instance-of v6, v0, Ln/d;

    if-eqz v6, :cond_6

    check-cast v0, Ln/d;

    invoke-interface {v0, p1, p2, p5, p3}, Ln/d;->e(III[I)V
...
.method public final d(IIII[II[I)Z
    ...
    iget-boolean v3, v1, Ln/c;->d:Z

    const/4 v9, 0x0

    if-eqz v3, :cond_a

    invoke-virtual {p0, v2}, Ln/c;->e(I)Landroid/view/ViewParent;
    ...
    :cond_2
    :goto_0
    iget-object v12, v1, Ln/c;->c:Landroid/view/View;
    ...
    invoke-virtual {v10, v0, v2, v3}, Landroidx/core/widget/NestedScrollView;->n(II[I)V
    ...
    instance-of v3, v10, Ln/d;

    iget-object v4, v1, Ln/c;->c:Landroid/view/View;

    if-eqz v3, :cond_7

    check-cast v10, Ln/d;

    invoke-interface {v10, v0, v2}, Ln/d;->d(II)V
...
.method public final e(I)Landroid/view/ViewParent;
    ...
    :cond_0
    iget-object p1, p0, Ln/c;->b:Landroid/view/ViewParent;

    return-object p1

    :cond_1
    iget-object p1, p0, Ln/c;->a:Landroid/view/ViewParent;
...
.method public final f(I)Z
    ...
    invoke-virtual {p0, p1}, Ln/c;->e(I)Landroid/view/ViewParent;
...
.method public final g(II)Z
    ...
    invoke-virtual {p0, p2}, Ln/c;->f(I)Z
    ...
    iget-object v0, p0, Ln/c;->c:Landroid/view/View;
    ...
    invoke-interface {v8, p1, p2}, Ln/d;->b(II)Z
    ...
    :cond_3
    iput-object v3, p0, Ln/c;->b:Landroid/view/ViewParent;

    goto :goto_2

    :cond_4
    iput-object v3, p0, Ln/c;->a:Landroid/view/ViewParent;
    ...
    invoke-interface {v3, v4, v0, p1, p2}, Ln/d;->a(Landroid/view/View;Landroid/view/View;II)V
...
.method public final h(I)V
    ...
    invoke-interface {v0, v2, p1}, Ln/d;->c(Landroid/view/View;I)V
    ...
    :cond_2
    iput-object v0, p0, Ln/c;->b:Landroid/view/ViewParent;

    goto :goto_1

    :cond_3
    iput-object v0, p0, Ln/c;->a:Landroid/view/ViewParent;
